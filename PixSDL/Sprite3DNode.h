...
namespace pix
{
	// Sprite3DNode is functionally a Sprite3D that can participate in a transform hierarchy.
	...
	public:
		...
		explicit Sprite3DNode(const SpriteMesh* mesh, const Vec3& position = Vec3(0.0, 0.0, 0.0), const Vec3f& scale = Vec3f(1.0f, 1.0f, 1.0f), const Rotation3D& rotation = Rotation3D());
