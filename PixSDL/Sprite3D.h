...
namespace pix
{
	...
	//
	// Philosophy:
	// Sprite3D is the minimal renderable 3D entity that can move through space.
	...
	public:
		...
		explicit Sprite3D(const SpriteMesh* mesh, const Vec3& position = Vec3(0.0, 0.0, 0.0), const Vec3f& scale = Vec3f(1.0f, 1.0f, 1.0f), const Rotation3D& rotation = Rotation3D());
