...
namespace pix
{
	// Sprite2DNode is functionally a Sprite2D that can participate in a transform hierarchy.
	...
	public:
		...
		explicit Sprite2DNode(const SpriteMesh* mesh, const Vec2& position = Vec2(0.0, 0.0), const Vec2f& scale = Vec2f(1.0f, 1.0f), const Rotation2D& rotation = Rotation2D());
