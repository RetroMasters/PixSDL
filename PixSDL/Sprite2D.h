...
namespace pix
{
	...
	//
	// Philosophy:
	// Sprite2D is the minimal renderable 2D entity that can move through space.
	...
	public:
		...
		explicit Sprite2D(const SpriteMesh* mesh, const Vec2& position = Vec2(0.0, 0.0), const Vec2f& scale = Vec2f(1.0f, 1.0f), const Rotation2D& rotation = Rotation2D());
